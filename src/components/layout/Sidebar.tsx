...
export function Sidebar() {
  ...
  return (
    <>
      {/* Mobile Top Bar */}
      <header className="lg:hidden w-full flex items-center justify-between px-4 py-3 bg-white/95 dark:bg-slate-950/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 sticky top-0 z-30 transition-colors shrink-0">
          ...
          <div className="flex items-center justify-between p-2 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
            <div className="flex items-center gap-2 truncate">
              ...
              <div className="truncate text-left">
                ...
                <div className="text-[9px] text-emerald-600 dark:text-emerald-400 font-semibold truncate flex items-center gap-1">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                  Sin contraseñas • Modo Demo
                </div>
              </div>
            </div>
          </div>
