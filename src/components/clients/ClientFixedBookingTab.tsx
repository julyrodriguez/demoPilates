...
export function ClientFixedBookingTab({
  ...
  const availableTimes = useMemo(() => {
    ...
    if (list.length === 0) {
      return [
        { time: "08:00", instructorName: "Sofía Valenzuela", count: 0 },
        { time: "09:00", instructorName: "Sofía Valenzuela", count: 0 },
        { time: "10:00", instructorName: "Sofía Valenzuela", count: 0 },
        { time: "11:00", instructorName: "Sofía Valenzuela", count: 0 },
        { time: "14:00", instructorName: "Sofía Valenzuela", count: 0 },
        { time: "15:00", instructorName: "Sofía Valenzuela", count: 0 },
        { time: "16:00", instructorName: "Sofía Valenzuela", count: 0 },
        { time: "17:00", instructorName: "Sofía Valenzuela", count: 0 },
        { time: "18:00", instructorName: "Sofía Valenzuela", count: 0 },
        { time: "19:00", instructorName: "Sofía Valenzuela", count: 0 },
      ];
    }
    return list;
  }, [monthShifts]);
  ...
  const handleConfirmFixedBooking = async () => {
    ...
    try {
      ...
      let representativeInstructor = "Sofía Valenzuela";
      ...
      for (const dateStr of datesToProcess) {
        ...
        if (!shift) {
          ...
          shift = await addShift({
            ...
            instructorName: firstExisting?.instructorName || "Sofía Valenzuela",
            room: "Sala Reformer",
            price: 0,
