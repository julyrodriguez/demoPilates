                ...
                >
                  ...
                  <div className="pt-2 border-t border-slate-200/60 dark:border-slate-800/60 flex items-center gap-1.5 sm:gap-2 w-full">
                    {(() => {
                      ...
                      const customMessage = `¡Hola ${b.clientName}! Te escribimos de ${settings.studioName || "Demo Pilates"} para recordarte tu clase de ${shift.title || "Pilates"} el día ${formatDate(shift.date)} a las ${shift.startTime} hs con la Prof. ${shift.instructorName || "del estudio"}. Por favor, ¿nos confirmas tu asistencia? ¡Muchas gracias! ✨`;
