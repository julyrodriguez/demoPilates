    ...
    <div className="glass-card overflow-hidden">
      ...
      <div className="block lg:hidden divide-y divide-slate-200 dark:divide-slate-800">
        {bookings.map((booking) => {
          ...
          const customMessage = `¡Hola ${booking.clientName}! Te escribimos de Demo Pilates para recordarte tu clase de ${booking.shiftTitle || "Pilates"} el día ${formatDate(booking.shiftDate)} a las ${booking.shiftTime} hs con la Prof. ${booking.instructorName || "del estudio"}. Por favor, ¿nos confirmas tu asistencia? ¡Muchas gracias! ✨`;
